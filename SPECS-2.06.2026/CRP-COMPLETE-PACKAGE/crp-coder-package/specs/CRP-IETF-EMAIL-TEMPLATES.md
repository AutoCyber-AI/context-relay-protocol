...
Looking for guidance on the right home for two I-Ds I've submitted:

  draft-vidiniotis-crp-headers — HTTP header fields for AI context safety
  draft-vidiniotis-crp-safety-policy — CSP-inspired directive language
