...
This is a working draft of the CRP Core Specification. It is published for review and comment. Feedback may be submitted via the CRP GitHub repository at `github.com/crprotocol/spec`.
