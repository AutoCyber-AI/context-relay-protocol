...
3. SIGNUP / SIGN-IN (Clerk)
   The result_token is carried through the Clerk signup flow (as a query
...
Run a scan (no account needed, public repo / SARIF)
   ...
   → sign up to keep them (Clerk org created)
...
- CRP-SPEC-047 — Monetisation (Clerk org = the account results are claimed into)
