...
from crp.comply.billing.constants import CREDIT_COST_PER_CALL_CENTS
...
class InMemoryUsageStore:
    ...
    def get(self, org_id: str, period_key: str) -> int:
        """Return the recorded usage count for *org_id* in *period_key*."""
    ...
    def add_credit(self, org_id: str, cents: int) -> None:
        """Add *cents* of prepaid credit to the org's balance."""
