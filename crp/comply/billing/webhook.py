...
class StripeWebhookHandler:
        ...
        if mode == "subscription":
            ...
            try:
                ...
                metadata = {
                    ...
                    "features": PLAN_FEATURES.get(plan, ["governance"]),
            ...
            if add_cents:
                try:
                    ...
                    logger.info(
                        "Added %d cents credit to org %s", add_cents, org_id,
                    )
                except Exception:
    ...
    def _on_customer_subscription_deleted(self, event: dict[str, Any]) -> None:
        ...
        _update_clerk_org(org_id, metadata)
        logger.info("Downgraded org %s to free (subscription deleted)", org_id)
