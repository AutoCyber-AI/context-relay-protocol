...
<section class="slide">
  ...
  <div class="grid-3">
    ...
    <div class="feature"><strong>Model-agnostic</strong><br/>Identical governance contract on LM Studio, OpenAI, Anthropic, or a hosted model.</div>
    ...
    <div class="feature"><strong>Quality gate proven</strong><br/>Full SQB benchmark passes against a hosted frontier model with all five gate criteria.</div>
  </div>
</section>
