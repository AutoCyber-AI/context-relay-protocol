...
**Files:**
- `examples/crp_demos/live_crp_slm_proof.py` — full side-by-side proof including single tool, tool chain, RAG, and long-form report.
- `examples/crp_demos/live_llm_vs_crp.py` — compact one-question demo.
