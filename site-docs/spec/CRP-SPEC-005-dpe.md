...
<span id="11-stage-9-flow--continuity-analysis"></span>
...
3. MUST publish the weight configuration in the conformance report (CRP-SPEC-014 §3).
4. MUST preserve the **relative ordering** of signal importance as described in §16.2.
