...
!!! info "Go-to-market detail is internal"
    The concrete free-to-paid funnel, conversion triggers, and expansion
    mechanics are documented internally because they describe commercial
    strategy rather than protocol behaviour. The public site describes the
    available plans on the [Pricing](../pricing.md) page and the developer
    onboarding path in the [Getting Started](../getting-started/quickstart.md)
    guide.
...
Open drives adoption and invites community adapters and backends.
